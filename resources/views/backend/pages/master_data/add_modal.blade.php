                        ...
                        <div class="intro-y box p-5">
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5 mb-3">
                                <div class="col-span-12 lg:col-span-6">
                                    ...
                                    <textarea name="check_point" id="check_point" class="form-control" cols="5" rows="5"></textarea>
                                </div>
                                <div class="col-span-12 lg:col-span-6">
                                    <label for="crud-form-1" class="form-label">รายการที่เสีย</label>
                                    <textarea name="broken_item" id="broken_item" class="form-control" cols="5" rows="5"></textarea>
                                </div>
                            </div>
