            ...
            <div class="intro-y box p-5 mt-5">
                <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                    <div class="sm:flex items-center sm:mr-4">
                        ...
                        <select id="search_choice" name="search_choice" class="myLike form-select w-full sm:w-40 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
        ...
        function getdatatable(){
            new Tabulator("#datatable_01", {
                ...
                columns:[
                    ...
                    {field: 'action_name',   title :'<center>ชื่อ</center>', minWidth: 150, vertAlign:"middle" , formatter:"html",  width:'30%',responsive:1}, // 1
                    {field: 'type',   title :'<center>ประเภท</center>', minWidth: 150, vertAlign:"middle" , formatter:"html",  width:'15%',responsive:1}, // 1
                    {field: 'created_at',    title :'<center>วันที่สร้าง</center>', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'15%',responsive:2}, // 2
                    {field: 'status',    title :'<center>การแสดงในหน้าindex</center>', formatter:"html", vertAlign:"middle",  hozAlign: "center",    width:'20%'}, // 3
