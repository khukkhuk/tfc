        ...
        function getdatatable(){
            new Tabulator("#datatable_01", {
                ...
                columns:[
                    ...
                    {field: 'action_name',   title :'<center>ชื่อ</center>', minWidth: 200, vertAlign:"middle" , formatter:"html",  width:'55%',responsive:1}, // 1
                    {field: 'created_at',    title :'<center>วันที่สร้าง</center>', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'10%',responsive:2}, // 2
                    {field: 'status',    title :'<center>สถานะ</center>', formatter:"html", vertAlign:"middle",  hozAlign: "center",    width:'10%'}, // 3
